        ...
        <div class="dashboard-layout">
            ...
            <div class="col-side">
                ...
                <div class="quick-actions">
                    <a href="content.php" class="action-btn"><i class="fas fa-plus"></i> Add Artwork</a>
                    <a href="reservations.php" class="action-btn secondary"><i class="fas fa-calendar"></i> View Calendar</a>
                </div>
            </div>
